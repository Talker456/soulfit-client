...
class MeetingRepositoryImpl implements MeetingRepository {
  ...
  @override
  Future<Map<String, dynamic>> getAiRecommendedMeetings({required int page, required int size}) async {
    return await remoteDataSource.getAiRecommendedMeetings(page: page, size: size);
  }
