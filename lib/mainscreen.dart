...
import 'package:soulfit_client/dating_main.dart';
import 'package:soulfit_client/community_main.dart';
import 'package:soulfit_client/group.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget _buildCommunitySection(BuildContext context) {
    return Column(
      children: [
        ...
        const Divider(color: Color(0xFF79C72B), thickness: 1.5),
  ...
  Widget _buildBottomNavBar() {
    return BottomNavigationBar(
      ...
      selectedItemColor: const Color(0xFF79C72B),
